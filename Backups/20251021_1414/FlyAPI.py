...
# v1.35.3
# - FIX: prevent both camera panels picking the same device by auto-assigning
#        distinct defaults after "Refresh Cameras" (PySpin first, then OpenCV)
# - Keeps: PySpin System held for lifetime, released at app exit only
